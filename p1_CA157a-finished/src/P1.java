                        ...
                        do{
                            ...
                            switch (selection_c){
                                case "1":
                                    ...
                                    System.out.println("Please input the information follow the order: Customer ID->Type->Initial amount:");
                                    System.out.println("Customer ID(Numbers. If no, to open a new customer), Type(C for Checking; S for Saving), Initial amount(Numbers. >=0)");
